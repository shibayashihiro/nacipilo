...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>NAC Philotechnics | Waste Management</title>
    ...
    <body class="page-container-bg-solid page-boxed">     
        <!-- BEGIN HEADER -->           
        <?php 
            $menu['parent'] = 'radiological';
            $menu['current'] = 'capabilities';
                ...
                <div class="page-content">
                    <div class="container">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            <li>
                                <a href="#">Radiological & Health Physics</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span href="#">Capabilities</span>  
                            </li>                            
                        </ul>
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Capabilities Content</span>
                                            </div>                                         
                                        </div>
                                            ...
                                            <form action="#" class="form-horizontal form-bordered ">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Our Capabilities</label>
                                                        <div class="col-md-9">
                                                                ...
                                                                foreach ($capabilities as $capability) {
                                                                    ?>
                                                                        <div class='core-value'>                                                                
                                                                            <span><?php echo $capability['Content'];?></span>
                                                                            <div class='core-value-buttons'>                                                                    
                                                                                <button type="button" class="btn blue btn-sm btn-circle" onclick='editValue(<?php echo $capability["ID"];?>)'><i class='icon-pencil'></i></button>&nbsp;
                                                                                <button type="button" class="btn red btn-sm btn-circle" onclick='deleteValue(<?php echo $capability["ID"];?>)'><i class='icon-trash'></i></button>
                                                                            </div>
                                                                        </div>
                                                                    <?php
                                                                }
                                ...
                                <form action="" class="form-horizontal form-bordered" id='addNewForm'>
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Content</label>
                                            <div class="col-md-9">
                                                <textarea id='ContentEdit' class='form-control'></textarea>
                                            </div>
                                        </div>                                        
                                    </div>                                    
                                </form>
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/radiological/capabilities.js');?>" type="text/javascript"></script>
