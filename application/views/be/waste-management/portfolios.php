...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-boxed">     
                ...
                <div class="page-content">
                    <div class="container">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            <li>
                                <a href="index.html">Waste Management</a>
                                                        ...
                                                        <div class='col-md-4 col-sm-6 col-xs-12'>
                                                            ...
                                                            <div class="portlet light profile-portlet">
                                                                ...
                                                                <div class="profile-pic">
                                                                    <img src="<?php echo base_url('assets/resources/'.$image['Attach']);?>" class="img-responsive" alt="">
                                                                </div>
                                                                    
                                                                <!-- END SIDEBAR USERPIC -->
                                                                <!-- SIDEBAR BUTTONS -->
                                                                <div class="profile-buttons">
                                                                    <button type="button" class="btn btn-circle green btn-sm" onclick='editService(<?php echo $image["ID"];?>)'>EDIT</button>
                                                                    <button type="button" class="btn btn-circle red btn-sm" onclick="deleteService(<?php echo $image['ID'];?>)">DELETE</button>
                                                                </div>
                                                                <!-- END SIDEBAR BUTTONS -->
                                                            </div>
                                                            <!-- END PORTLET MAIN -->  
                                ...
                                <form action="" class="form-horizontal form-bordered" id='newPortfolioForm' enctype="multipart/form-data">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class='col-md-9'>
                                                <input type='hidden' name='Type' value='waste-portfolio'>
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/aboutus/portfolios.js');?>" type="text/javascript"></script>
