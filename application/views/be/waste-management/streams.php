...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-boxed">     
                ...
                <div class="page-content">
                    <div class="container">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            <li>
                                <a href="#">Waste Managment</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span href="#">Waste Streams</span>  
                            </li>                            
                        </ul>
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Waste Stream Content</span>
                                            </div>                                         
                                        </div>
                                            ...
                                            <form action="#" class="form-horizontal form-bordered ">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Our Streams</label>
                                                        <div class="col-md-9">
                                                                ...
                                                                foreach ($streams as $stream) {
                                                                    ?>
                                                                        <div class='core-value'>                                                                
                                                                            <span><?php echo $stream['Content'];?></span>
                                                                            <div class='core-value-buttons'>                                                                    
                                                                                <button type="button" class="btn blue btn-sm btn-circle" onclick='editValue(<?php echo $stream["ID"];?>)'><i class='icon-pencil'></i></button>&nbsp;
                                                                                <button type="button" class="btn red btn-sm btn-circle" onclick='deleteValue(<?php echo $stream["ID"];?>)'><i class='icon-trash'></i></button>
                                                                            </div>
                                                                        </div>
                                                                    <?php
                                                                }
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/waste-management/streams.js');?>" type="text/javascript"></script>
