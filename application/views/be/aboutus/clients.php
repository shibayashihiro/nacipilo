...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>NAC Philotechnics | About Us</title>
    ...
    <body class="page-container-bg-solid page-boxed">     
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Clients Content</span>
                                            </div>                                         
                                        </div>
                                            ...
                                            <form action="#" class="form-horizontal form-bordered ">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Our Clients</label>
                                                        <div class="col-md-9">
                                                                ...
                                                                foreach ($clients as $client) {
                                                                    ?>
                                                                        <div class='core-value'>                                                                
                                                                            <span><?php echo $client['Content'];?></span>
                                                                            <div class='core-value-buttons'>                                                                    
                                                                                <button type="button" class="btn blue btn-sm btn-circle" onclick='editValue(<?php echo $client["ID"];?>)'><i class='icon-pencil'></i></button>&nbsp;
                                                                                <button type="button" class="btn red btn-sm btn-circle" onclick='deleteValue(<?php echo $client["ID"];?>)'><i class='icon-trash'></i></button>
                                                                            </div>
                                                                        </div>
                                                                    <?php
                                                                }
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/aboutus/clients.js');?>" type="text/javascript"></script>
