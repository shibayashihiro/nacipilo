...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-boxed">     
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Jobs Content</span>
                                            </div>                                         
                                        </div>
                                        <div class="portlet-body">
                                            <div class='blog-new'>
                                                <a type='button' class='btn green' href="<?php echo base_url('admin/career/job/edit/0');?>"><i class='icon-plus'></i>&nbsp;&nbsp;Add New</a>
                                            </div>
                                                            ...
                                                            foreach ($jobs as $job) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style='max-width: 100px;'>
                                                                        <a href="<?php echo base_url('admin/career/job/edit/'.$job['ID']);?>" class="btn btn-outline btn-circle btn-sm purple">
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/career/jobs.js');?>?<?php echo time(); ?>" type="text/javascript"></script>  
