...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-boxed">     
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Career Sumary Content</span>
                                            </div>                                         
                                        </div>
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/career/summary.js');?>" type="text/javascript"></script>
