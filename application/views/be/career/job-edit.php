...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>NAC Philotechnics | <?php echo ($ID == 0 ? "NEw Job" : "Job Edit");?></title>
    ...
    <body class="page-container-bg-solid page-boxed">     
                                            ...
                                            <form action="#" class="form-horizontal form-bordered " id='jobForm'>
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group last">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div id="sumnoteContent"><?php echo $Description;?></div>
                                                            <input type='hidden' id='inputContent' name='Description'>
                                                        </div>
                                                    </div>             
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-2 col-md-10">
                                                            ...
                                                            <a type='button' class='btn default' href='<?php echo base_url('admin/career/jobs');?>'><i class='fa fa-mail-reply-all'></i> Cancel</a>
                                                        </div>                                                        
                                                    </div>
                                                </div>
                                            </form>
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/career/job-edit.js');?>" type="text/javascript"></script>  
