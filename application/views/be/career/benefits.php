...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>NAC Philotechnics | Career</title>
    ...
    <body class="page-container-bg-solid page-boxed">     
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Benefits Content</span>
                                            </div>                                         
                                        </div>
                                            ...
                                            <form action="#" class="form-horizontal form-bordered ">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Our Beneftis</label>
                                                        <div class="col-md-9">
                                                                ...
                                                                foreach ($benefits as $benefit) {
                                                                    ?>
                                                                        <div class='core-value'>                                                                
                                                                            <span><?php echo $benefit['Content'];?></span>
                                                                            <div class='core-value-buttons'>                                                                    
                                                                                <button type="button" class="btn blue btn-sm btn-circle" onclick='editValue(<?php echo $benefit["ID"];?>)'><i class='icon-pencil'></i></button>&nbsp;
                                                                                <button type="button" class="btn red btn-sm btn-circle" onclick='deleteValue(<?php echo $benefit["ID"];?>)'><i class='icon-trash'></i></button>
                                                                            </div>
                                                                        </div>
                                                                    <?php
                                                                }
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/career/benefits.js');?>" type="text/javascript"></script>
